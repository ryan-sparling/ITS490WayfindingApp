...
import OOOcomponentNameOOO from "../../../src/client/tiles/{{filename}}/components/{{filename}}";

const stories = storiesOf('{{desc}} | Tile / Multiple', module);

stories.addDecorator(withKnobs);

const items = [
  {
    tileComponent: OOOcomponentNameOOO,
    menuOption: {
      desc: "Tile One",
